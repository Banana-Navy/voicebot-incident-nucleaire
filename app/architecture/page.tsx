...
function ControlDiagram() {
  return <div className="control-diagram" aria-label="Schéma des couches de contrôle"><span className="diagram-node one"><img src="/icons/nuclear/phone.png" alt="Entrée téléphonique" /></span><span className="diagram-node two"><img src="/icons/nuclear/chat.png" alt="Dialogue" /></span><span className="diagram-node three"><img src="/icons/nuclear/audio.png" alt="Analyse audio" /></span><span className="diagram-node four"><img src="/icons/nuclear/shield-check.png" alt="Contrôle de sécurité" /></span><div className="diagram-layers" aria-hidden="true"><span className="diagram-layer" /><span className="diagram-layer" /><span className="diagram-layer" /><img className="diagram-center" src="/nuclear-logo.png" alt="" /></div></div>;
}
