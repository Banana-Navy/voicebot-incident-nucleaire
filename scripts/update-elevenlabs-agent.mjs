...
const payload = {
  ...
  version_description: "Keep the selected voice while using continuous spoken paragraphs, natural English backchannels and more varied context-aware responses.",
};
